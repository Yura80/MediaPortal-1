...
namespace TvLibrary.Implementations.DVB
{
  ...
  /// DVB IP class
  /// </summary>
  public class TvCardDVBIPVLC : TvCardDVBIP
  {
    /// <summary>
    /// CLSID_MPVlcSource
    /// </summary>
    [ComImport, Guid("3C0C7451-993F-460A-A714-6A034BDE98CD")]
    public class MPVlcSource {}
    ...
    {
      Log.Log.WriteFile("dvbip:Add MediaPortal VLC Source Filter");
      _filterStreamSource = FilterGraphTools.AddFilterFromClsid(_graphBuilder, typeof (MPVlcSource).GUID,
                                                                "MediaPortal VLC Source Filter");
    ...
    protected override void RemoveStreamSourceFilter()
    {
      if (_filterStreamSource != null)
      {
        ...
        Release.ComObject("MediaPortal VLC Source Filter", _filterStreamSource);
